<html>
    ...
    <table>
        <tr style="width:100%;">
            <td style="width:90%;">
                <table>
                    <tr><td>PEMERINTAH DESA/KELURAHAN</td><td>: {{desa}}</td></tr>

                    <tr><td>KECAMATAN</td><td>: {{kecamatan}}</td></tr>

                    <tr><td>KABUPATEN</td><td>: {{kabupaten}}</td></tr>
                </table>    
            </td>
            <td style="width:10%;">
    ...
    <p>Kami yang bertanda tangan di bawah ini, Luraj / Kepala Desa: {{desa}}, Kecamatan {{}}, Kabupaten {{}}, dengan ini menerangkan dengan sebenar-benarnya, bahwa tanah yang dimiliki oleh {{}}... seluas ± {{}}m2, adalah betul-betul merupakan tanah Milik Adat sejak sebelum tanggal 14 September 1960. </p>
