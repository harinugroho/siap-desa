...
@section('script')
    ...
    $( ".add-button" ).click(function() {
        $( "#rows" ).append('<div class="row" id="row'+id+'"><div class="col-md-2"><div class="form-group"><label>Tanggal</label><input name="tgl_1" type="date" class="form-control" placeholder="Masukkan Nama Lurah/Kepala Desa" autofocus value=""></div></div><div class="col-md-4"><div class="form-group"><label>Nama Pemilik Baru</label><input name="nama_1" type="text" class="form-control" placeholder="Masukkan Nama Pemilik Baru" autofocus value=""></div></div><div class="col-md-4"><div class="form-group"><label>No. Buku C</label><input name="no_buku_c_1" type="text" class="form-control" placeholder="Masukkan NIP Lurah/ Kepala Desa" autofocus value=""></div></div><div class="col-md-2"><span class="btn btn-success add-button">+</span><span class="btn btn-danger remove-button">-</span></div></div>');
        i++;
        });
