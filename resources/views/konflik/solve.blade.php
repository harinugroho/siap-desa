...
@section('content')
    <div class="header container">Selesaikan Konflik pada tanah milik {{$pemilik->nama}}</div>
    <div class="container" style="padding-bottom:10px; padding-top:0px;">
        <ol class="breadcrumb">
            ...
            <li class="active">Selesaikan Konflik</li>
        </ol>
        ...
        @endif
        <form action="{{ URL::to("konflik/solve/$konflik->id") }}" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis" class="form-control">
                            <option {{(old('jenis')==0)?"selected":""}} value="0">Pengajuan Penyelesaian</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <center>
                ...
                <input type="hidden" name="konflik_id" value="{{$konflik->id}}">
